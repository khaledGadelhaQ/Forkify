...
var _confingJs = require("./confing.js");
...
const getRecipe = async ()=>{
    try {
        ...
        (0, _resultsViewJsDefault.default).update(_modelJs.loadSearchResultsPage());
        // 1) render spinner
...
const getSearchResults = async ()=>{
    try {
        ...
        /// render the results
        (0, _resultsViewJsDefault.default).render(_modelJs.loadSearchResultsPage());
...
const controlPagination = (page)=>{
    try {
        // render the page
        (0, _resultsViewJsDefault.default).render(_modelJs.loadSearchResultsPage(page));
        // render the pagination buttons
        (0, _paginationViewJsDefault.default).render(_modelJs.state.search);
    } catch (err) {
        throw err;
...
const controlUploadRecipe = async function(data) {
    try {
        ...
        (0, _addRecipeViewJsDefault.default).renderMessage("Your recipe was successfully uploaded :)");
        ...
        }, (0, _confingJs.CLOSE_FORM_TIME) * 1000);
    } catch (err) {
        (0, _addRecipeViewJsDefault.default).renderErrorMessage("Wrong ingredints Format! Please use the correct Format :)");
        setTimeout(()=>{
            // we reload the page to be able add a recipe again
            window.location.reload();
        }, (0, _confingJs.CLOSE_FORM_TIME) * 1000);
...
(function() {
    ...
    (0, _bookmarksViewJsDefault.default).addHandlerRender(loadBookmark);
    ...
    (0, _searchViewJsDefault.default).addHandlerRender(getSearchResults);
    (0, _paginationViewJsDefault.default).addHandlerClick(controlPagination);
    (0, _addRecipeViewJsDefault.default).addHandlerUpload(controlUploadRecipe);
})();

},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21","./confing.js":"ex4bO","./Views/recipeView.js":"17Msr","./Views/searchView.js":"1ldzZ","./Views/resultsView.js":"2WfRw","./Views/paginationView.js":"4oefe","./Views/bookmarksView.js":"hXwQt","./Views/addRecipeView.js":"4LvUr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const state = {
    ...
    search: {
        query: "",
        results: [],
        page: (0, _confing.FIRST_PAGE),
        resultsPerPage: (0, _confing.RECIPES_PER_PAGE)
    },
    bookmarks: []
};
...
const loadRecipe = async (id)=>{
    try {
        const data = await (0, _helpers.AJAX)(`${(0, _confing.API_URL)}/${id}`);
...
const loadSearchResults = async (query)=>{
    try {
        ...
        state.search.page = (0, _confing.FIRST_PAGE);
        const data = await (0, _helpers.AJAX)(`${(0, _confing.API_URL)}?search=${query}&key=${(0, _confing.KEY)}`);
...
const loadSearchResultsPage = (page = state.search.page)=>{
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const data = await (0, _helpers.AJAX)(`${(0, _confing.API_URL)}?key=${(0, _confing.KEY)}`, recipe);
        state.recipe = getDataObject(data);
...
},{"./confing":"ex4bO","./helpers":"hGI1E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ex4bO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "CLOSE_FORM_TIME", ()=>CLOSE_FORM_TIME);
const API_URL = "https://forkify-api.herokuapp.com/api/v2/recipes";
const TIMEOUT_SEC = 10;
const RECIPES_PER_PAGE = 10;
const FIRST_PAGE = 1;
const KEY = "447f5fea-1340-4409-939b-cf88cbf6aaee";
const CLOSE_FORM_TIME = 2.5;
...
const AJAX = async (URL, uploadedData = null)=>{
    try {
        ...
        const response = await Promise.race([
            fetchDataPromise,
            timeout((0, _confing.TIMEOUT_SEC))
        ]);
...
},{"./confing":"ex4bO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"17Msr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = "No Ruestls Found For Your Search, Please Try Again!";
    _message = "";
...
},{"./View.js":"3BOfc","url:../../img/icons.svg":"loVOp","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3BOfc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2WfRw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./previewView":"jn7RE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jn7RE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./View":"3BOfc","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4oefe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkUp() {
        ...
        if (curPage === 1 && numPages > 1) return this._getNextPage(curPage + 1);
        // a middle page (prv and next buttons)
        if (curPage > 1 && curPage < numPages) return this._getNextPage(curPage + 1) + this._getPrvPage(curPage - 1);
        // last page (prv)
        if (curPage > 1 && curPage === numPages) return this._getPrvPage(curPage - 1);
...
},{"./View":"3BOfc","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hXwQt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _previewView = require("./previewView");
var _previewViewDefault = parcelHelpers.interopDefault(_previewView);
...
},{"./previewView":"jn7RE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4LvUr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"3BOfc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hycaY","aenu9"], "aenu9", "parcelRequire3a11")
